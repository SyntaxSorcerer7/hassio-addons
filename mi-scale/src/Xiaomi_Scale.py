...
# User Config
class USER:
    def __init__(self, name, gt, lt, sex, height, dob, garmin_mail, garmin_password):
        self.NAME, self.GT, self.LT, self.SEX, self.HEIGHT, self.DOB, self.garmin_mail, self.garmin_password
